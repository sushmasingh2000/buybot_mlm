...
export const endpoint = {
  ...
  save_token: `${domain}/api/v1/save-token`,
  unread_notifications_count: `${domain}/api/v1/unread-count`,
  notifications_list: `${domain}/api/v1/list`,
  mark_notification_read: `${domain}/api/v1/mark-as-read`,
